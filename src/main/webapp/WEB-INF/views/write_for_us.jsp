 ...
 <html lang="en">
   <head>
<!-- Original URL: http://www.risingelection.com/write-for-us
Date Downloaded: 8/24/2018 10:59:56 PM !-->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12">
           ...
           <li class="active">Write for us </li>
         </ol>
                 </div>
 ...
 <div id="innerpage" class="graybg">   <div class="container">     <div class="row">       <div class="container">         <div class="row">           <div class="col-md-5">             <h2>Write for us </h2>             <p>For any queries feel ____ to contact at support@risingelection.com __ reach directly at +91 7378 720 720. </p>
           </div>           <div class="col-md-7">             <form method="post" id="writetousForm" class="questionForm">                 <input type="hidden" name="hide" />               <div id="writetousSuccess"></div>               <div class="form-group">                 <input type="text" class="form-control" name="writetousName" id="writetousName" placeholder="Name" />               </div>               <div class="form-group">                 <input type="email" class="form-control" name="writetousEmail" id="writetousEmail" placeholder="Email" />               </div>               <div class="form-group">                 <input type="text" class="form-control" name="writetousContact" id="writetousContact" placeholder="Contact" />               </div>               <div class="form-group">                 <input type="text" class="form-control" name="writetousSubject" id="writetousSubject" placeholder="Subject" />               </div>               <div class="form-group">                 <textarea class="form-control" name="writetousComments" id="writetousComments" placeholder="Comments"></textarea>               </div>               <button type="submit" class="btn btn-default">Submit </button>             </form>           </div>         </div>       </div>     </div>   </div></div>
