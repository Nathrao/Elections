 ...
 <html lang="en">
   <head>
<!-- Original URL: http://www.risingelection.com/complaints
Date Downloaded: 8/24/2018 10:57:44 PM !-->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <div class="innerpage-content"><div class="container">
   <div class="row">
	 <div class="col-md-2"><button class="complaint-button" data-toggle="modal" data-target="#myModal">Create Complaint </button></div>
     <div class="col-md-5">
         <div class="complaint-box">
             <div class="complaint-header"><img src="images/comp-gaven.png" alt="" /> Ongoing Complaint </div>
                     </div>
         <div class="viewmore"><a href="http://www.risingelection.com/ongoing-complaint">View More </a></div>
     ...
     <div class="col-md-5">
       <div class="complaint-box">
           <div class="complaint-header"><img src="images/comp-gaven.png" alt="" /> Complaint Solved  </div>

          

       </div>
       <div class="viewmore"><a href="http://www.risingelection.com/complaint-solved">View More </a></div>
