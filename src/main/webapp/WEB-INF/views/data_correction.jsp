 ...
 <html lang="en">
   <head>
<!-- Original URL: http://www.risingelection.com/data-correction
Date Downloaded: 8/24/2018 10:58:04 PM !-->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12">
           ...
           <li class="active">Data Correction </li>
         </ol>
                 </div>
 ...
 <div id="innerpage" class="graybg">   <div class="container">     <div class="row">       <div class="container">         <div class="row">           <div class="col-md-5">             <h2>WANT TO WRITE FOR __ </h2>             <p>We welcome your thoughts, _____ to us and if ___ you feel you have _ voice that needs to __ heard, we will publish ____ post here </p>           </div>           <div class="col-md-7">             <form method="post" id="dataCorrectionForm" class="questionForm">               <input type="hidden" name="hide" />               <div id="dataCorrectionSuccess"></div>               <div class="form-group">                 <input type="text" class="form-control" name="dataCorrectionName" id="dataCorrectionName" placeholder="Name*" />               </div>               <div class="form-group">                 <input type="email" class="form-control" name="dataCorrectionEmail" id="dataCorrectionEmail" placeholder="Email*" />               </div>               <div class="form-group">                 <input type="text" class="form-control" name="dataCorrectionContact" id="dataCorrectionContact" placeholder="Contact*" />               </div>               <div class="form-group">                 <input type="text" class="form-control" name="dataCorrectionURL" id="dataCorrectionURL" placeholder="Page URL*" />               </div>               <div class="form-group">                 <textarea class="form-control" name="dataCorrectionComments" placeholder="Correction Comments*" id="dataCorrectionComments"></textarea>               </div>               <button type="submit" class="btn btn-default">Submit </button>             </form>           </div>         </div>       </div>     </div>   </div></div>
