               ...
               <div class="row">
                  <div class="col-md-2 col-xs-6">
                     <ul class="list-unstyled">
                        <li><a href="./election.footer.about.us">About Us</a> </li>
                        <li><a href="./election.footer.election.copyright">Copyright</a></li>
                        <li><a href="./election.footer.advertise">Advertise</a></li>
                     </ul>
                  </div>
                  <div class="col-md-2 col-xs-6">
                     <ul class="list-unstyled">
                        <li><a href="./election.home">Home</a></li>
                        <li><a href="./news.channels">News
                           Channels</a>
                        </li>
                     </ul>
                  </div>
                  <div class="col-md-2 col-xs-6">
                     <ul class="list-unstyled">
                        <li><a
                           href="./election.footer.archive.dyk">Archive Did you Know</a>
                        </li>
                        <li><a
                           href="./election.footer.archive.view.polls">Archive View Polls</a>
                        </li>
                        <li><a href="./election.footer.web.sitemap">Sitemap</a></li>
                     </ul>
                  </div>
                  <div class="col-md-2 col-xs-6">
                     <ul class="list-unstyled">
                  ...
                  <div class="col-md-2 col-xs-6">
                     <ul class="list-unstyled">
                        <li><a href="./election.footer.have.question">Have
                           a question?</a>
                        </li>
                        <li><a href="./election.footer.data.correction">Data
                           Correction</a>
                        </li>
                        <li><a href="./election.footer.faq">FAQ</a></li>
                     </ul>
                  </div>
               </div>
            </div>
