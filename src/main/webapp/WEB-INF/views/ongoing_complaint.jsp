 ...
 <html lang="en">
   <head>
<!-- Original URL: http://www.risingelection.com/ongoing-complaint
Date Downloaded: 8/24/2018 10:58:59 PM !-->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
     <meta charset="utf-8" />
     <meta http-equiv="X-UA-Compatible" content="IE=edge" />
     <meta name="viewport" content="width=device-width, initial-scale=1" />
     <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
     <title>Ongoing Complaint </title>
 ...
 <div class="complaintbannerinner">
   <div class="container">
     <div class="row">
       <div class="col-md-12">
           <h1 class="pull-left">Ongoing Complaint </h1>
           <div class="bread-crum">
                     <ol class="breadcrumb">
           <li><a href="http://www.risingelection.com/">Home </a></li>

           <li class="active">Ongoing Complaint </li>
           </ol>
                     </div>
       </div>
