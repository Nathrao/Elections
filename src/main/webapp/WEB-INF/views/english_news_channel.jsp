 ...
 <html lang="en">
   <head>
<!-- Original URL: http://www.risingelection.com/english-news-channel
Date Downloaded: 8/24/2018 10:59:55 PM !-->
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
     <meta charset="utf-8" />
     <meta http-equiv="X-UA-Compatible" content="IE=edge" />
     <meta name="viewport" content="width=device-width, initial-scale=1" />
     <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
     <title>English News Channel </title>
 ...
 <div class="header">
  ...
  <div class="innerbannerfooter">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
            <h1>English News Channel </h1>

            <div class="bread-crum">
                    <ol class="breadcrumb">
            <li><a href="http://www.risingelection.com/">Home </a></li>

            <li class="active">English News Channel </li>
          </ol>
                   </div>
 ...
 <div class="row">
 <div class="col-md-3"><a href="http://www.bbc.com/" target="_blank"><img alt="aaj tak" class="img-responsive" src="http://www.risingelection.com/images/bba.gif" /></a></div>

 <div class="col-md-3"><a href="http://www.cbc.ca/news" target="_blank"><img alt="z news" class="img-responsive" src="http://www.risingelection.com/images/cbc.png" /></a></div>

 <div class="col-md-3"><a href="http://english.cctv.com/" target="_blank"><img alt="aaj tak" class="img-responsive" src="http://www.risingelection.com/images/cctv.png" /></a></div>

 <div class="col-md-3"><a href="http://www.cnbc.com/world/?region=world" target="_blank"><img alt="abp news" class="img-responsive" src="http://www.risingelection.com/images/cnbc.gif" /></a></div>
 </div>

 <p>&nbsp; </p>

 <div class="row">
 <div class="col-md-3"><a href="http://edition.cnn.com/" target="_blank"><img alt="india news" class="img-responsive" src="http://www.risingelection.com/images/cnn.png" /></a></div>

 <div class="col-md-3"><a href="http://www.euronews.com/" target="_blank"><img alt="Euro news" class="img-responsive" src="http://www.risingelection.com/images/Euro_news.png" /></a></div>

 <div class="col-md-3"><a href="http://www.foxnews.com/" target="_blank"><img alt="Fox News" class="img-responsive" src="http://www.risingelection.com/images/Fox_News.gif" /></a></div>

 <div class="col-md-3"><a href="http://www.msnbc.com/msnbc-live" target="_blank"><img alt="msnbc" class="img-responsive" src="http://www.risingelection.com/images/msnbc.gif" /></a></div>
 </div>

 <p>&nbsp; </p>

 <div class="row">
 <div class="col-md-3"><a href="http://www.sabc.co.za/wps/portal/SABC/SABCHOME" target="_blank"><img alt="24 news 7" class="img-responsive" src="http://www.risingelection.com/images/sabc.png" /></a></div>
 </div>
     </div>
   </div>
 </div>
