 ...
 <html lang="en">
   <head>
<!-- Original URL: http://www.risingelection.com/have-a-question
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12">
           ...
           <li class="active">Have a question? </li>
         </ol>
                 </div>
 ...
 <div id="innerpage" class="graybg">   <div class="container">     <div class="row">       <div class="container">         <div class="row">           <div class="col-md-5">             <h2>WANT TO WRITE FOR __ </h2>             <p>We welcome your thoughts, _____ to us and if ___ you feel you have _ voice that needs to __ heard, we will publish ____ post here </p>           </div>           <div class="col-md-7">             <form method="post" id="questionForm" class="questionForm">               <input type="hidden" name="hide" />               <div id="questionSuccess"></div>               <div class="form-group">                 <input type="text" class="form-control" name="questionName" id="questionName" placeholder="Name*" />               </div>               <div class="form-group">                 <input type="email" class="form-control" name="questionEmail" id="questionEmail" placeholder="Email*" />               </div>               <div class="form-group">                 <input type="text" class="form-control" name="questionContact" id="questionContact" placeholder="Contact*" />               </div>               <div class="form-group">                 <input type="text" class="form-control" name="questionQuestion" id="questionQuestion" placeholder="Question related to" />               </div>               <div class="form-group">                 <textarea class="form-control" name="questionComments" placeholder="Question?*" id="questionComments"></textarea>               </div>               <button type="submit" class="btn btn-default">Submit </button>             </form>           </div>         </div>       </div>     </div>   </div></div>
