...
<html lang="en">
 ...
 <div class="innerbannerfooter">
   <div class="container">
     <div class="row">
       <div class="col-md-12">
           <h1>Archive View Polls </h1>
           <div class="bread-crum">
                  <ol class="breadcrumb">
           <li><a href="http://www.risingelection.com/">Home </a></li>

           <li class="active">Archive View Polls </li>
         </ol>
                 </div>
 ...
 <div id="innerpage" class="graybg">   <div class="container">     <div class="row">       <div class="container">         <div class="row">           <div class="col-md-12">             <div class="pagedid">Does Modi’s political invincibility _____ continue? <br /><br />Yes: 77%&nbsp;&nbsp;&nbsp;&nbsp;No: 23%&nbsp;&nbsp;&nbsp;&nbsp;Total: 35&nbsp;&nbsp;&nbsp;&nbsp; </div><div class="pagedid">Whether Demonetisation had impacted ______ Economy <br /><br />Yes: 100%&nbsp;&nbsp;&nbsp;&nbsp;No: 0%&nbsp;&nbsp;&nbsp;&nbsp;Total: 1&nbsp;&nbsp;&nbsp;&nbsp; </div>           </div>         </div>       </div>     </div>   </div></div>
